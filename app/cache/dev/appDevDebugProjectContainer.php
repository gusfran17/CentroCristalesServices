...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'guzzle.client.ws_crm_rest' => 'getGuzzle_Client_WsCrmRestService',
            'guzzle_bundle.formatter' => 'getGuzzleBundle_FormatterService',
            'guzzle_bundle.logger' => 'getGuzzleBundle_LoggerService',
            'guzzle_bundle.middleware.event_dispatch.ws_crm_rest' => 'getGuzzleBundle_Middleware_EventDispatch_WsCrmRestService',
            'guzzle_bundle.middleware.log.ws_crm_rest' => 'getGuzzleBundle_Middleware_Log_WsCrmRestService',
            'guzzle_bundle.middleware.request_header.ws_crm_rest' => 'getGuzzleBundle_Middleware_RequestHeader_WsCrmRestService',
            'guzzle_bundle.middleware.wsse.ws_crm_rest' => 'getGuzzleBundle_Middleware_Wsse_WsCrmRestService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('base_scripts' => array(0 => array(0 => '@LCSAppBundle/Resources/public/js/jquery-2.1.4.min.js', 1 => '@LCSAppBundle/Resources/public/bootstrap/js/bootstrap.min.js', 2 => '@LCSAppBundle/Resources/public/js/jquery.form.js', 3 => '@LCSAppBundle/Resources/public/js/lcs.namespace.js', 4 => '@LCSAppBundle/Resources/public/js/lcs.ui.js', 5 => '@LCSAppBundle/Resources/public/js/lcs.navigation.js', 6 => '@LCSAppBundle/Resources/public/jquery.validation/jquery.validate.min.js', 7 => '@LCSAppBundle/Resources/public/jquery.validation/localization/messages_es_AR.min.js', 8 => '@LCSAppBundle/Resources/public/js/lcs.validation.extension.js', 9 => '@LCSAppBundle/Resources/public/moment/moment-with-locales.min.js', 10 => '@LCSAppBundle/Resources/public/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js'), 1 => array(), 2 => array()))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LCSAppBundle', ($this->targetDirs[2].'/Resources/LCSAppBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LCSAppBundle', ($this->targetDirs[3].'\\src\\LCS\\AppBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('v2.0', '%s?%s');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3307, 'dbname' => 'centrocr_app', 'user' => 'centrocr', 'password' => 'marce1830', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    /**
     * Gets the 'guzzle.client.ws_crm_rest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzle_Client_WsCrmRestService()
    {
        $a = \GuzzleHttp\HandlerStack::create();
        $a->push($this->get("guzzle_bundle.middleware.wsse.ws_crm_rest")->attach());
        $a->push($this->get("guzzle_bundle.middleware.request_header.ws_crm_rest")->attach());
        $a->push($this->get("guzzle_bundle.middleware.log.ws_crm_rest")->log());
        $a->unshift($this->get("guzzle_bundle.middleware.event_dispatch.ws_crm_rest")->dispatchEvent());

        return $this->services['guzzle.client.ws_crm_rest'] = new \GuzzleHttp\Client(array('base_uri' => 'http://centrocristales.dynns.com:8094/WSCRMREST/WarnesWSRest.svc/', 'handler' => $a, 'auth' => array(0 => 'acme', 1 => 'pa55w0rd'), 'timeout' => 30));
    }
    ...
    /**
     * Gets the 'guzzle_bundle.middleware.event_dispatch.ws_crm_rest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_EventDispatch_WsCrmRestService()
    {
        return $this->services['guzzle_bundle.middleware.event_dispatch.ws_crm_rest'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\EventDispatchMiddleware($this->get('debug.event_dispatcher'), 'ws_crm_rest');
    }

    /**
     * Gets the 'guzzle_bundle.middleware.log.ws_crm_rest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_Log_WsCrmRestService()
    {
        return $this->services['guzzle_bundle.middleware.log.ws_crm_rest'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\LogMiddleware($this->get('guzzle_bundle.logger'), $this->get('guzzle_bundle.formatter'));
    }

    /**
     * Gets the 'guzzle_bundle.middleware.request_header.ws_crm_rest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_RequestHeader_WsCrmRestService()
    {
        return $this->services['guzzle_bundle.middleware.request_header.ws_crm_rest'] = new \EightPoints\Bundle\GuzzleBundle\Middleware\RequestHeaderMiddleware(array('Accept' => 'application/json'));
    }

    /**
     * Gets the 'guzzle_bundle.middleware.wsse.ws_crm_rest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGuzzleBundle_Middleware_Wsse_WsCrmRestService()
    {
        return $this->services['guzzle_bundle.middleware.wsse.ws_crm_rest'] = new \EightPoints\Guzzle\WsseAuthMiddleware('acme', 'pa55w0rd');
    }
    ...
    /**
     * Gets the 'lcs_app.clients.service1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LCS\AppBundle\Services\Clients\Service1 A LCS\AppBundle\Services\Clients\Service1 instance.
     */
    protected function getLcsApp_Clients_Service1Service()
    {
        return $this->services['lcs_app.clients.service1'] = new \LCS\AppBundle\Services\Clients\Service1('http://centrocristales.dynns.com:8094/wscrm/service1.asmx?WSDL', 'http://centrocristales.dynns.com:8094/wscrm/service1.asmx?WSDL');
    }

    /**
     * Gets the 'lcs_app.type.image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LCS\AppBundle\Form\Type\ImageType A LCS\AppBundle\Form\Type\ImageType instance.
     */
    protected function getLcsApp_Type_ImageService()
    {
     ...
     * This method always returns the same instance of the service.
     *
     * @return \LCS\ServicioBundle\Service\ConsultaOrdenTrabajoService A LCS\ServicioBundle\Service\ConsultaOrdenTrabajoService instance.
     */
    ...
    /**
     * Gets the 'lcs_servicio.service.pedidopresupuesto' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LCS\ServicioBundle\Service\PedidoPresupuestoService A LCS\ServicioBundle\Service\PedidoPresupuestoService instance.
     */
    protected function getLcsServicio_Service_PedidopresupuestoService()
    {
        return $this->services['lcs_servicio.service.pedidopresupuesto'] = new \LCS\ServicioBundle\Service\PedidoPresupuestoService($this->get('swiftmailer.mailer.default'), $this->get('templating'), array('consultasapp@centrocristales.com' => 'Consultas Centro Cristales'), 'consultasapp@centrocristales.com', (__DIR__.'/attachments/'));
    }

    /**
     * Gets the 'lcs_webservice.service.pedidopresupuesto' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LCS\WebServiceBundle\Service\PedidoPresupuestoService A LCS\WebServiceBundle\Service\PedidoPresupuestoService instance.
     */
    protected function getLcsWebservice_Service_PedidopresupuestoService()
    {
        return $this->services['lcs_webservice.service.pedidopresupuesto'] = new \LCS\WebServiceBundle\Service\PedidoPresupuestoService($this->get('swiftmailer.mailer.default'), $this->get('templating'), array('consultasapp@centrocristales.com' => 'Consultas Centro Cristales'), 'consultasapp@centrocristales.com', (__DIR__.'/attachments/'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('consultasapp@centrocristales.com');
        $a->setPassword('123cc321');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('centrocristales.dynns.com');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'gabrielromero@gmail.com', 1 => 'aimara.larraza@gmail.com'), array(0 => '/@lacomarcasistemas\\.com\\.ar$/', 1 => '/^aimara\\.larraza@gmail\\.com$/'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'LCSAppBundle:Form:fields.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'LCSAppBundle:Form:fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'LCSAppBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b9922ab2f02273306d852df389317709e8ff6c93');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('583d51739d30d4.30025626')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NoiseLabsNuSOAPBundle' => 'NoiseLabs\\Bundle\\NuSOAPBundle\\NoiseLabsNuSOAPBundle',
                'LCSWebServiceBundle' => 'LCS\\WebServiceBundle\\LCSWebServiceBundle',
                'LCSServicioBundle' => 'LCS\\ServicioBundle\\LCSServicioBundle',
                'GuzzleBundle' => 'EightPoints\\Bundle\\GuzzleBundle\\GuzzleBundle',
                'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle',
                'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle',
                'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle',
                'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle',
                'LCSAppBundle' => 'LCS\\AppBundle\\LCSAppBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appDevDebugProjectContainer',
            'database_host' => 'localhost',
            'database_port' => 3307,
            'database_name' => 'centrocr_app',
            'database_user' => 'centrocr',
            'database_password' => 'marce1830',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'centrocristales.dynns.com',
            'mailer_user' => 'consultasapp@centrocristales.com',
            'mailer_password' => '123cc321',
            'mailer_port' => 2525,
            'mailer_encryptation' => NULL,
            'mailer_sender' => array(
                'consultasapp@centrocristales.com' => 'Consultas Centro Cristales',
            ),
            'mailer_pedido_presupuesto_address' => 'consultasapp@centrocristales.com',
            'mailer_attachments_dir' => (__DIR__.'/attachments/'),
            'secret' => 'b9922ab2f02273306d852df389317709e8ff6c93',
            'app_version' => 'v2.0',
            'lcs_app.service1.wsdl' => 'http://centrocristales.dynns.com:8094/wscrm/service1.asmx?WSDL',
            'lcs_app.service1.endpoint' => 'http://centrocristales.dynns.com:8094/wscrm/service1.asmx?WSDL',
            'lcs_app.service1.dateformat' => 'd/m/Y h:i:s a',
            'lcs_app.ws_crm_rest.base_url' => 'http://centrocristales.dynns.com:8094/WSCRMREST/WarnesWSRest.svc/',
            'lcs_app.companias' => array(
                254 => 'ALLIANZ AREGENTINA SEGUROS',
                15725 => 'AMCA',
                256 => 'ARGOS CIA. DE SEGUROS',
                31456 => 'ASEGURADORA FEDERAL',
                278 => 'BERKLEY SEGUROS S.A.',
                272 => 'BOSTON SEGUROS',
                48412 => 'CALEDONIA ARGENTINA COMPAÑIA DE SEGUROS S.A',
                4673 => 'CHUBB ARGENTINA DE SEGUROS',
                5818 => 'CIA DE SEG.EL NORTE S.A.',
                3046 => 'EL PROGRESO SEGUROS S.A.',
                238 => 'ESCUDO SEGUROS S.A.',
                273 => 'FEDERACION PATRONAL LTDA.',
                39335 => 'GENERALI ARGENTINA COMPAÑIA DE SEGUROS SA',
                35743 => 'HDI SEGUROS',
                282 => 'INTEGRITY',
                43505 => 'LA CAJA CIA. DE SEGUROS',
                4280 => 'LA EQUITATIVA DEL PLATA S.A DE SEGUROS',
                284 => 'LA HOLANDO SUD. COMP. DE SEG. S.A.',
                44169 => 'LA NUEVA SOC.COOP.DE SEG.',
                39542 => 'LA PERSEVERANCIA SEGUROS S.A.',
                243 => 'LA SEGUNDA C.L.S.G.',
                38040 => 'MAPFRE ACONCAGUA CIA.SEG.',
                250 => 'MERCANTIL ANDINA',
                248 => 'MERIDIONAL SEGUROS',
                595 => 'NACION SEGUROS',
                260 => 'ORBIS CIA DE SEGUROS S.A.',
                281 => 'PARANA S.A. DE SEGUROS',
                277 => 'PROVINCIA SEGUROS',
                259 => 'PRUDENCIA CIA. DE SEGUROS',
                253 => 'QBE SEGUROS LA BUENOS AIRES S.A..',
                263 => 'RIO URUGUAY COOP.DE SEG.Ltda',
                271 => 'ROYAL & SUNALLIANCE - Answer',
                262 => 'SAN CRISTOBAL SOC. MUTUAL',
                276 => 'SANCOR COOP.DE SEG.LTDA.',
                59869 => 'SEGURCOOP',
                542 => 'SMG SEGUROS S.A.',
            ),
            'lcs_app.mensajes.estado_ot' => array(
                'NOENCONTRADA' => 'No se encontró la Orden de Trabajo. Por favor verifique el número de Orden de Trabajo y Dominio y vuelva a intentarlo',
                'ENT' => 'Su vehículo se encuentra en TALLER',
                'PAS' => 'Su vehículo se encuentra TERMINADO',
            ),
            'locale' => 'en',
            ...
            'kernel.secret' => 'b9922ab2f02273306d852df389317709e8ff6c93',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'LCSAppBundle:Form:fields.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'centrocristales.dynns.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'consultasapp@centrocristales.com',
            'swiftmailer.mailer.default.transport.smtp.password' => '123cc321',
            ...
            'swiftmailer.mailer.default.single_address' => 'gabrielromero@gmail.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'gabrielromero@gmail.com',
                1 => 'aimara.larraza@gmail.com',
            ),
            'swiftmailer.mailer.default.delivery_whitelist' => array(
                0 => '/@lacomarcasistemas\\.com\\.ar$/',
                1 => '/^aimara\\.larraza@gmail\\.com$/',
            ),
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'gabrielromero@gmail.com',
