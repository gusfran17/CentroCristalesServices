...
namespace Proxies\__CG__\LCS\ServicioBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Banner extends \LCS\ServicioBundle\Entity\Banner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LCS\\ServicioBundle\\Entity\\Banner' . "\0" . 'id', '' . "\0" . 'LCS\\ServicioBundle\\Entity\\Banner' . "\0" . 'link', '' . "\0" . 'LCS\\ServicioBundle\\Entity\\Banner' . "\0" . 'fileName', '' . "\0" . 'LCS\\ServicioBundle\\Entity\\Banner' . "\0" . 'file');
        }
