...
class appProdProjectContainer extends Container
{
    ...
    protected function getGuzzle_Client_WsCrmRestService()
    {
        ...
        return $this->services['guzzle.client.ws_crm_rest'] = new \GuzzleHttp\Client(array('base_uri' => 'http://centrocristales.dynns.com:8094/WSCRMREST/WarnesWSRest.svc/', 'handler' => $a, 'timeout' => 30));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57bc3d4eabf2e7.47565532')), true);
